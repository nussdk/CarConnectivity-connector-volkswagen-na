...
class Connector(BaseConnector):
    ...
    def __init__(self, connector_id: str, car_connectivity: CarConnectivity, config: Dict, *args, initialization: Optional[Dict] = None, **kwargs) -> None:
        BaseConnector.__init__(self, connector_id=connector_id, car_connectivity=car_connectivity, config=config, log=LOG, api_log=LOG_API, *args, initialization=initialization, **kwargs)
        ...
        if data is not None:
            ...
            if isinstance(vehicle, VolkswagenNAElectricVehicle):
                ...
                if 'climateSettings' in climate_data and climate_data['climateSettings'] is not None:
                    ...
                    log_extra_keys(LOG_API, 'climatizationElementSettings', climatization_element_settings, {'carCapturedTimestamp',
